        ...
        <div class="right">
          <div v-for="item in paginatedData" style="margin-top: 15px">
            <div class="res">
              ...
              <div v-show="defaultType === '作者'">
                <el-row>
                  <el-col :span="12">
                    <div class="author">
                      <span style="margin-left: 30px; font-size: 12px">机构：</span>
                      <span
                        style="
                          border: solid 1px;
                          color: rgb(45, 118, 80);
                          ...
                          font-size: 12px;
                        "
                        @click="toInstitution(item.institution)"
                        >{{ item.institution }}</span
                      >
                    </div>
                  </el-col>
                  <el-col :span="12">
                    <span style="margin-left: 30px; font-size: 12px">领域：</span>
                    <span
                      style="
                        background-color: rgb(45, 118, 80);
                        margin: 15px 5px 0 0;
              ...
              <div v-show="defaultType === '机构'">
                <el-row>
                  <el-col :span="12">
                    <div class="author">
                      <span style="margin-left: 30px; font-size: 12px">所在地：</span>
                      <span
                        style="
                          border: solid 1px;
                          color: rgb(45, 118, 80);
